          ...
          <div class="card-content">
            ...
            <div class="material-datatables">
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <hp>Acá podras darle gestion a tus productos.</hp>
                <br>
                ...
                <div class="wrapper">
                  ...
                  @foreach ($productos_propios as $items)
                  <div class="col-lg-3">
                    <div class="card card-pricing card-raised">
                      <div class="content">
                        ...
                        <a href="{{ route('producto.show',$items->id) }}" class="btn btn-rose btn-round">Modificar</a>
                      </div>
                    </div>
                  </div>
                  @endforeach
